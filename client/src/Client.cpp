...
int main()
{
    ...
    for (int i = 0; i < NUM_MOVEMENT_ENTITIES; i++) {
        // ModelComposite
        playersModel[i] = new sge::ModelComposite("/Users/MP/Desktop/SP24/CSE 125/group5/client/rock_w_tex/rock2.obj");
    }
    sge::ModelComposite envMap("/Users/MP/Desktop/SP24/CSE 125/group5/client/rock_w_tex/env_fixed.obj");
    envMapPtr = &envMap;
...
void clientLoop()
{
    ...
    while (!glfwWindowShouldClose(sge::window))
    {
        ...
        sge::ModelComposite::updateCameraToFollowPlayer(clientGame->positions[clientGame->client_id], clientGame->yaws[clientGame->client_id], clientGame->pitches[clientGame->client_id]); 
